...
function mousedown(e) {
    document.getElementById(e.toLowerCase()).style.backgroundColor = 'rgb(245, 209, 9)';
    commands = e;
    sendCommands();
}
...
addEventListener("DOMContentLoaded", function () {
    ...
    forward.addEventListener('touchend', e => mouseup('forward'), false);
    forward.addEventListener('mouseup', e => mouseup('forward'), false);
    /*
    ...
    */
    ...
    backward.addEventListener('touchend', e => mouseup('backward'), false);
    backward.addEventListener('mouseup', e => mouseup('backward'), false);
    /*
    ...
    */
    ...
    left.addEventListener('touchend', e => mouseup('left'), false);
    left.addEventListener('mouseup', e => mouseup('left'), false);
    /*
    ...
    */
    ...
    right.addEventListener('touchend', e => mouseup('right'), false);
    right.addEventListener('mouseup', e => mouseup('right'), false);
    /*
...
$(document).ready(function(){
    ...
    switch (vformat) {
        ...
        case '105':
            ...
            break;
        default:
            document.getElementById('remote-video').style.width = "3500px";
            document.getElementById('remote-video').style.height = "100px";
    }
    /*
     // Disable video casting. Not supported at the moment with hw codecs.
     var elements = document.getElementsByName('video_cast');
